  ...
  <body>
    ...
    <div class="container-fluid mt-3">
        <div class="d-flex mb-2 mx-2">
            <div class="button">
              <a class="btn btn-success ms-3 px-3" href="create.php"><i class="fas fa-plus"></i></a>
              <a class="btn btn-primary ms-3 px-3" href="<?= $url_print_food; ?>"><i class="fas fa-print"></i></a>
            </div>
                        ...
                        <div class="collapse navbar-collapse mt-1" id="<?=$r->food_id; ?>">
                          <ul class="navbar-nav ms-auto mb-2 mb-lg-0 text-white">
                            <div class="d-flex justify-content-between mt-2 mb-2">
                              <a href="update.php?food_id=<?= $r->food_id;?>" class="btn btn-success w-100 me-1"><i class="far fa-edit"></i></a>
                              <a href="delete.php?food_id=<?=$r->food_id; ?>" class="btn btn-danger w-100 ms-1"><i class="far fa-trash-alt"></i></a>    
                            </div>
                          </ul>
                        </div>  
                    </div>
